...
function getDogsByZip(zipcode) {
 ...
 const realDogs = [{
  ...
  },
  {
    ...
    age : 8,
    breed : 'Beagle',
    image: 'https://drive.google.com/uc?id=1z-i103rrV-j3aLOj3GhsEY-iTYgeyHAJ'
  ...
  },
  {
    ...
    age : 4,
    breed : 'Corgi',
    image: 'https://drive.google.com/uc?id=1i4fCSJRxgsQWe5jmgJmbhn846QR6d_97'
  ...
  },
  {
    ...
    age : 3,
    breed : 'Husky',
    image: 'https://drive.google.com/uc?id=1gDDntzIZr3-E8PoKG-0haY7YstokjZ0K'
  ...
  },
  {
    ...
    age : 4,
    breed : 'Labradoodle',
    image: 'https://drive.google.com/uc?id=1jhle-dr_n-inqAK656mLeOLBS6bw5Hoh'
    //image : 'https://thenypost.files.wordpress.com/2018/09/85327728.jpg?quality=90&strip=all&w=618&h=410&crop=1'
  }
];

 export default {realDogs,getDogsByZip,getDogShelterZipCodes,shelterZipCodes, currentZip};